<template>
  <div class="cardList">
    <SortingPanel
        @update:sortByRatingAsc="sortByRatingAsc"
        @update:sortByRatingDesc="sortByRatingDesc"
        @update:cancelSorting="cancelSorting"
        :color="options.color"
    />
...
<script setup>
  ...
  import SortingPanel from "../components/sorting-panel.vue";
  ...
  function cancelSorting() {
    const sortedCards = cards.value.slice();
